...
CREATE INDEX IF NOT EXISTS idx_nty_message_template_status ON nty_message_template(channel_config_id, status, deleted);
...
create sequence IF NOT EXISTS nty_channel_configuration_SEQ start with 1 increment by 1;
CREATE INDEX IF NOT EXISTS idx_nty_channel_configuration_type ON nty_channel_configuration(type, deleted);
...
create sequence IF NOT EXISTS nty_message_record_SEQ start with 1 increment by 1;
CREATE INDEX IF NOT EXISTS idx_nty_message_record_template_id ON nty_message_record(template_id, status, created_time);
