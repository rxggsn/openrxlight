 ...
 * 请阅读：
 * 公众平台：<a href=
 * "https://developers.weixin.qq.com/doc/offiaccount/Getting_Started/Global_Return_Code.html">全局返回码说明</a>
...
public class WxError {
    ...
    public static WxError fromJson(String json, WxType type) {
        final WxError wxError = JsonUtils.fromJson(json, WxError.class);
