...
import static cn.ggsn.openrxlight.account.external.impl.wechat.error.WxMpErrorMsgEnum.*;
...
public class WxConsts {
    ...
    public static class KefuMsgType {
        ...
        /**
         * 发送图文消息（点击跳转到图文消息页面）使用通过 “发布” 系列接口得到的 article_id(草稿箱功能上线后不再支持客服接口中带 media_id 的
         * mpnews 类型的图文消息)
         */
    ...
    public static class EventType {
         ...
         * 授权用户资料变更事件
         * 1、
         * 当部分用户的资料存在风险时，平台会对用户资料进行清理，并通过消息推送服务器通知最近30天授权过的公众号开发者，我们建议开发者留意响应该事件，及时主动更新或清理用户的头像及昵称，降低风险。
