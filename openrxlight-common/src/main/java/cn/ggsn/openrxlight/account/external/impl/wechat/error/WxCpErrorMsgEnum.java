 ...
 * 企业微信全局错误码.
 * 参考文档：<a href=
"https://work.weixin.qq.com/api/doc/90000/90139/90313">企业微信全局错误码</a>
...
public enum WxCpErrorMsgEnum {
    ...
    /**
     * 参数 english_name
     * 不合法；参数如果有传递，不允许为空字符串，同时不能超过64字节，只能是由字母、数字、点(.)、减号(-)、空格或下划线(_)组成.
     */
    ...
    /**
     * 组织架构不合法（1不是一棵树，2 多个一样的partyid，3 partyid空，4 partyid name 空，5 同一个父节点下有两个子节点
     * 部门名字一样 可能是以上情况，请一一排查）.
     */
    CODE_302004(302004,
