...
public class OkHttpProxyInfo {
    ...
    public OkHttpProxyInfo(ProxyType proxyType, String proxyHost, int proxyPort, String proxyUser,
     ...
     */
    public static OkHttpProxyInfo socks5Proxy(String proxyAddress, int proxyPort, String proxyUser,
            String proxyPassword) {
     ...
     * Creates HTTP proxy.
     */
    public static OkHttpProxyInfo httpProxy(String proxyAddress, int proxyPort, String proxyUser,
            String proxyPassword) {
